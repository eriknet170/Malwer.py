...
def show_menu(ip_monitor):
    while True:
        ...
        print(f"  ├───┼───────────────────────────────────────────────┤")
        print(f"  │ {colors.BOLD}2{colors.RESET}{colors.GREEN} │ Network Anonymity Tools                 {colors.GREEN}│")
        print(f"  ├───┼───────────────────────────────────────────────┤")
        print(f"  │ {colors.BOLD}3{colors.RESET}{colors.GREEN} │ Secure Communication Tools             {colors.GREEN}│")
        print(f"  ├───┼───────────────────────────────────────────────┤")
        print(f"  │ {colors.BOLD}4{colors.RESET}{colors.GREEN} │ Privacy Cleaner                        {colors.GREEN}│")
        print(f"  ├───┼───────────────────────────────────────────────┤")
        ...
        print(f"  ├───┼───────────────────────────────────────────────┤")
        print(f"  │ {colors.BOLD}7{colors.RESET}{colors.GREEN} │ Exit                                   {colors.GREEN}│")
        print(f"  └───┴───────────────────────────────────────────────┘{colors.RESET}")
...
def tor_menu():
    while True:
        ...
        print(f"  ├───┼───────────────────────────────────────────────┤")
        print(f"  │ {colors.BOLD}3{colors.RESET}{colors.GREEN} │ Edit TOR Configuration                 {colors.GREEN}│")
        print(f"  ├───┼───────────────────────────────────────────────┤")
...
# Menu de anonimato de rede
def network_anonymity_menu():
    while True:
        animated_banner()
        print(f"\n{colors.BOLD}{colors.WHITE}NETWORK ANONYMITY TOOLS:{colors.RESET}")
        print(f"  {colors.GREEN}┌───┬───────────────────────────────────────────────┐")
        print(f"  │ {colors.BOLD}1{colors.RESET}{colors.GREEN} │ MAC Address Spoofing                   {colors.GREEN}│")
        print(f"  ├───┼───────────────────────────────────────────────┤")
        print(f"  │ {colors.BOLD}2{colors.RESET}{colors.GREEN} │ VPN Management                         {colors.GREEN}│")
        print(f"  ├───┼───────────────────────────────────────────────┤")
        print(f"  │ {colors.BOLD}3{colors.RESET}{colors.GREEN} │ DNS Protection                         {colors.GREEN}│")
        print(f"  ├───┼───────────────────────────────────────────────┤")
        print(f"  │ {colors.BOLD}4{colors.RESET}{colors.GREEN} │ Back to Main Menu                     {colors.GREEN}│")
        print(f"  └───┴───────────────────────────────────────────────┘{colors.RESET}")
